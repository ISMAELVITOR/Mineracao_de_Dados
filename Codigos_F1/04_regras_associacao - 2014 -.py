...
WHERE r.grid > 0
AND ra.year BETWEEN {ANO_INICIAL} AND {ANO_FINAL}

""").df()

print("\n")
print("=" * 70)
print(f"BASE - PERIODO {ANO_INICIAL}-{ANO_FINAL}")
print("=" * 70)
...
if len(regras) == 0:
    ...
    regras_exportacao.to_csv(
        ...
        RESULTADOS_DIR / "regras_associacao_2014_2024.csv",
    ...
    itemsets_exportacao.to_csv(
        ...
        RESULTADOS_DIR / "itemsets_frequentes_2014_2024.csv",
